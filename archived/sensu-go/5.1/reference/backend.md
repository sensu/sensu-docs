...
| key-file   |      |
-------------|------
description  | SSL/TLS certificate key. This key secures communications between Sensu Dashboard and end user web browsers, as well as communication between sensuctl and the Sensu API.
type         | String
default      | `""`
example      | {{< highlight shell >}}# Command line example
