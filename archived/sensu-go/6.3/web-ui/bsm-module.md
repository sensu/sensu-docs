...
1. Click ![services icon](/images/archived_version_images/old_web_ui_services_icon.png) in the left navigation menu to open the Services page.
...
{{< figure src="/images/archived_version_images/old_create_service.gif" alt="Add a new business service with the web UI module" link="/images/archived_version_images/old_create_service.gif" target="_blank" >}}
...
{{< figure src="/images/archived_version_images/old_create_service_component.gif" alt="Add a new service component to a business service with the web UI module" link="/images/archived_version_images/old_create_service_component.gif" target="_blank" >}}
...
{{< figure src="/images/archived_version_images/old_business_service_detail_page.png" alt="View the business service detail page" link="/images/archived_version_images/old_business_service_detail_page.png" target="_blank" >}}
...
{{< figure src="/images/archived_version_images/old_edit_service_component.png" alt="Edit a service component" link="/images/archived_version_images/old_edit_service_component.png" target="_blank" >}}
