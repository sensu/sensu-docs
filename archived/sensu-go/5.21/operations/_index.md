...
[Maintain Sensu][3] includes upgrade, migration, and troubleshooting information to keep your Sensu implementation running smoothly.
...
You can also learn how to [troubleshoot][22] to identify and resolve problems with your Sensu implementation, from reading and configuring Sensu service logs to using Sensu handlers and filters to test and debug your implementation.

## Monitor Sensu

[Monitor Sensu][4] covers how to [log Sensu services][24] and [monitor your Sensu backend][25] with a secondary Sensu instance.
...
Learn to configure secrets and secrets providers resources to obtain secrets from one or more external secrets providers, refer to external secrets, and consume secrets via backend environment variables.
