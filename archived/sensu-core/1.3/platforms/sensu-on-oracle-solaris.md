...
2. Install the `sensu-1.3.0-1.i386.pkg` package using the `pkgadd` utility:
   {{< code shell >}}
$ su
$ pkgadd -d sensu-1.3.0-1.i386.pkg{{< /code >}}
...
1. Download the Sensu [Solaris 11 package][14] or use the `wget` utility:
   {{< code shell >}}
wget https://eol-repositories.sensuapp.org/solaris/ips/5.11/sensu-1.3.0-1.i386.p5p{{< /code >}}

2. Install the `sensu-1.3.0-1.i386.p5p` package using the `pkg` utility:
   {{< code shell >}}
$ sudo pkg install -g sensu-1.3.0-1.i386.p5p developer/versioning/sensu{{< /code >}}
