...
2. The Sensu installer package for IBM AIX systems is provided in **backup file
   ...
   {{< code shell >}}
installp -ld sensu-1.3.0-1.powerpc.bff{{< /code >}}
   ...
   flag.
   {{< code shell >}}
installp -apXY -d sensu-1.3.0-1.powerpc.bff sensu{{< /code >}}

3. Install Sensu using the `installp` utility.
   {{< code shell >}}
installp -aXY -d sensu-1.3.0-1.powerpc.bff sensu{{< /code >}}
...
[3]:  https://eol-repositories.sensuapp.org/aix/6.1/sensu-1.3.0-1.powerpc.bff
