...
find_and_replace() {
  ...
  case $(uname) in
  "Linux")
    sed -i "s/${OLD_SENSU_VERSION}/${NEW_SENSU_VERSION}/g" content/sensu-go/${DOCS_VERSION}/installation/install-sensu.md content/sensu-go/${DOCS_VERSION}/installation/verify.md
    sed -i "s/${OLD_SENSU_BUILD}/${NEW_SENSU_BUILD}/g" content/sensu-go/${DOCS_VERSION}/installation/install-sensu.md content/sensu-go/${DOCS_VERSION}/installation/verify.md
    ;;
  "Darwin")
    sed -i '' "s/${OLD_SENSU_VERSION}/${NEW_SENSU_VERSION}/g" content/sensu-go/${DOCS_VERSION}/installation/install-sensu.md content/sensu-go/${DOCS_VERSION}/installation/verify.md
    sed -i '' "s/${OLD_SENSU_BUILD}/${NEW_SENSU_BUILD}/g" content/sensu-go/${DOCS_VERSION}/installation/install-sensu.md content/sensu-go/${DOCS_VERSION}/installation/verify.md
