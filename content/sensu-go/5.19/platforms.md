...
linkTitle: "Supported Platforms and Distributions"
description: "Sensu Go is available on a wide range of platforms, including Linux, Windows, and macOS, and offers binary-only distributions for Linux, Windows, macOS, FreeBSD, and Solaris. Learn which platforms you can use with the Sensu backend, Sensu agent, and sensuctl command line tool and download and verify Sensu binaries."
version: "5.19"
weight: -60
product: "Sensu Go"
...
In addition to [packages][19], Sensu binary-only distributions are available for Linux, Windows (agent and CLI only), macOS (CLI only), FreeBSD, and Solaris.
...
| arch | format |
| --- | --- |
| `386` | [`.tar.gz`][29] \| [`.zip`][35] |
| `amd64` | [`.tar.gz`][24] \| [`.zip`][30] |
| `arm64` | [`.tar.gz`][25] \| [`.zip`][31]
| `armv5` (agent and CLI) | [`.tar.gz`][26] \| [`.zip`][32] |
| `armv6` (agent and CLI) | [`.tar.gz`][27] \| [`.zip`][33] |
| `armv7` (agent and CLI) | [`.tar.gz`][28] \| [`.zip`][34] |
...
| `MIPS 64 LE hard float` | [`.tar.gz`][60] \| [`.zip`][61] |
| `MIPS 64 LE soft float` | [`.tar.gz`][62] \| [`.zip`][63] |
...
[19]: ../install-sensu/
[20]: ../../reference/backend#operation
[21]: ../../reference/agent#operation
[22]: ../../sensuctl/reference#first-time-setup
[23]: ../../guides/monitor-server-resources/
[24]: https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.19.0/sensu-go_5.19.0_linux_amd64.tar.gz
[25]: https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.19.0/sensu-go_5.19.0_linux_arm64.tar.gz
[26]: https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.19.0/sensu-go_5.19.0_linux_armv5.tar.gz
[27]: https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.19.0/sensu-go_5.19.0_linux_armv6.tar.gz
[28]: https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.19.0/sensu-go_5.19.0_linux_armv7.tar.gz
[29]: https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.19.0/sensu-go_5.19.0_linux_386.tar.gz
[30]: https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.19.0/sensu-go_5.19.0_linux_amd64.zip
[31]: https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.19.0/sensu-go_5.19.0_linux_arm64.zip
[32]: https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.19.0/sensu-go_5.19.0_linux_armv5.zip
[33]: https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.19.0/sensu-go_5.19.0_linux_armv6.zip
[34]: https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.19.0/sensu-go_5.19.0_linux_armv7.zip
[35]: https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.19.0/sensu-go_5.19.0_linux_386.zip
...
[60]: https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.19.0/sensu-go_5.19.0_linux_mips64le-hardfloat.tar.gz
[61]: https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.19.0/sensu-go_5.19.0_linux_mips64le-hardfloat.zip
[62]: https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.19.0/sensu-go_5.19.0_linux_mips64le-softfloat.tar.gz
[63]: https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.19.0/sensu-go_5.19.0_linux_mips64le-softfloat.zip
