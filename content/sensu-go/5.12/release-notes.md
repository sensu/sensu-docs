...
- Agents can now be configured with a list of executables which check and check hook commands are allowed to run. See the [agent reference][] for more information.
