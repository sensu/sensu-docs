...
Added sensuctl dump command to output resources to a file or STDOUT
Added agent --allow-list to list allowed executables for checks and check hooks.
...
Web UI performance has been improved for deployments with lots of events and entities.
