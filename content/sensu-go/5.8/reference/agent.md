...
- [Configuration](#configuration)
  ...
  - [Example](/sensu-go/5.8/files/agent.yml)
...
sensu-agent --statsd-event-handlers influx-db --statsd-flush-interval 1 --statsd-metrics-host 123.4.5.8 --statsd-metrics-port 8125
{{< /highlight >}}
...
See the example config file provided with Sensu packages at `/usr/share/doc/sensu-go-agent-5.8.0/agent.yml.example` or [available here](/sensu-go/5.8/files/agent.yml).
