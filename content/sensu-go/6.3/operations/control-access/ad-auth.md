...
type: "reference"
description: "Read this guide to learn about Sensu's support for single sign-on (SSO) authentication using Active Directory (AD) and configure an AD authentication provider."
weight: 50
version: "6.3"
product: "Sensu Go"
menu:
