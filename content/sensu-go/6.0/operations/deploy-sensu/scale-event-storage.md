...
Next, replace `<standby_ip>` with the IP address of your standby host and run the command to give the repl user permissions to replicate from the standby host:
