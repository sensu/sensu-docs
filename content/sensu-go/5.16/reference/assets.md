...
| annotations | |
-------------|------
description  | Non-identifying metadata that is meaningful to people who interact with Sensu.<br><br>In contrast to labels, you cannot use annotations in [API response filtering][20] or [sensuctl response filtering][21].
required     | false
