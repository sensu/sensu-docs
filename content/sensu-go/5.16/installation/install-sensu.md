...
Invoke-WebRequest https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.16.1/sensu-go-agent_5.16.1.BUILDNO_en-US.x64.msi  -OutFile "$env:userprofile\sensu-go-agent_5.16.1.BUILDNO_en-US.x64.msi"

# Or for Windows 386
Invoke-WebRequest https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.16.1/sensu-go-agent_5.16.1.BUILDNO_en-US.x86.msi  -OutFile "$env:userprofile\sensu-go-agent_5.16.1.BUILDNO_en-US.x86.msi"

# Install the Sensu agent
msiexec.exe /i $env:userprofile\sensu-go-agent_5.16.1.BUILDNO_en-US.x64.msi /qn
