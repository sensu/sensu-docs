...
**December 11, 2019** &mdash; The latest release of Sensu Go, version 5.16.0, is now available for download.
...
- ([Commercial feature][95]) Added ability to authenticate with OIDC in the dashboard.
...
- Added [`--keepalive-warning-timeout`][101] which is an alias of `--keepalive-timeout` for backwards compatibility.
