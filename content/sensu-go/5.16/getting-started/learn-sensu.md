...
You can also see the event and the entity in the [Sensu dashboard](http://localhost:3002). Log in to the dashboard with these pre-set admin credentials: username `admin` and password `P@ssw0rd!`.
