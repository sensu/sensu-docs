...
{{< highlight text >}}
Get-FileHash C:\Users\Administrator\sensu-go-5.0.1-windows-amd64.tar.gz -Algorithm SHA512 | Format-List
{{< /highlight >}}

The result should match (with the exception of capitalization) the output from the following commands.

{{< highlight text >}}
Invoke-WebRequest https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.0.1/sensu-go-5.0.1-windows-amd64.sha512sum -OutFile C:\Users\Administrator\sensu-go-5.0.1-windows-amd64.sha512sum

Get-Content C:\Users\Administrator\sensu-go-5.0.1-windows-amd64.sha512sum
{{< /highlight >}}
