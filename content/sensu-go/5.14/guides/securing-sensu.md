...
To use agent TLS authentication, use existing an existing certificate and key for the sensu agent,
or create a new certificate and key according to our [guide](#creating-self-signed-certificates)
