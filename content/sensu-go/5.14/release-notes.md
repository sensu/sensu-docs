...
- Addresses an issue where running [`sensuctl dump`][84] for multiple resource types with the output format as YAML separators were printed to `STDOUT` instead of the specified file.
