...
Sensu backends and agents will work on systems with FIPS kernel mode if the `require-fips` configuration option is set to `true` in the [backend][14] and [agent][15] configuration files.
