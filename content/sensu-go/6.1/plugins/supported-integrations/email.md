...
Our guide [Send email alerts with the Sensu Go Email Handler][3] demonstrates how to add and configure the Sensu Email Handler plugin.
Follow our [Up and running with Sensu Go][6] interactive tutorial for an in-browser demo of the Sensu Email Handler integration.
