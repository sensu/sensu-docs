...
Our guide [Send Slack alerts with handlers][3] demonstrates how to add and configure the Sensu Slack Handler plugin.
Follow our [Learn Sensu in 15 minutes][6] interactive tutorial for an in-browser demo of the Sensu Slack Handler integration.
