...
linkTitle: "SaltStack"
description: "Use the Sensu SaltStack Handler plugin to integrate Sensu with your existing SaltStack and SaltStack workflows. Read about the features of Sensu's SaltStack integration and learn how to get the plugin."
version: "6.1"
product: "Sensu Go"
menu: 
  sensu-go-6.1:
...
The Sensu SaltStack Handler plugin is a Sensu [handler][1] that launches SaltStack Jobs for automated remediation based on Sensu event data.
...
- [Event-based templating][2]: include observation data from event attributes to add meaningful, actionable context to SaltStack incidents, events, and Configuration Items.
