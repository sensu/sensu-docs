...
Invoke-WebRequest https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/6.1.0/sensu-go_6.1.0_windows_amd64.zip  -OutFile C:\Users\Administrator\sensu-go_6.1.0_windows_amd64.zip

# Or for 386
Invoke-WebRequest https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/6.1.0/sensu-go_6.1.0_windows_386.zip  -OutFile C:\Users\Administrator\sensu-go_6.1.0_windows_386.zip
{{< /code >}}
...
Invoke-WebRequest https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/6.1.0/sensu-go-agent_6.1.0.3465_en-US.x64.msi  -OutFile "$env:userprofile\sensu-go-agent_6.1.0.3465_en-US.x64.msi"

# Or for Windows 386
Invoke-WebRequest https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/6.1.0/sensu-go-agent_6.1.0.3465_en-US.x86.msi  -OutFile "$env:userprofile\sensu-go-agent_6.1.0.3465_en-US.x86.msi"

# Install the Sensu agent
msiexec.exe /i $env:userprofile\sensu-go-agent_6.1.0.3465_en-US.x64.msi /qn
