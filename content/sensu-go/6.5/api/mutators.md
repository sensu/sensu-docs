...
corev2api_title: "core/v2/mutators"
type: "corev2_api"
version: "6.5"
product: "Sensu Go"
menu:
...
{{% notice note %}}
**NOTE**: Requests to the core/v2 API mutators endpoint require you to authenticate with a Sensu [API key](../#configure-an-environment-variable-for-api-key-authentication) or [access token](../#authenticate-with-the-authentication-api).
