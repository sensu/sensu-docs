---
title: "enterprise/licensing/v2/license"
...
enterpriseapi_title: "enterprise/licensing/v2/license"
type: "enterprise_api"
version: "6.5"
product: "Sensu Go"
menu:
...
{{% notice note %}}
**NOTE**: Requests to the licensing API require you to authenticate with a Sensu [API key](../#configure-an-environment-variable-for-api-key-authentication) or [access token](../#authenticate-with-the-authentication-api).
