...
{{% notice note %}}
**NOTE**: Requests to the core/v2 API role bindings endpoint require you to authenticate with a Sensu [API key](../#configure-an-environment-variable-for-api-key-authentication) or [access token](../#authenticate-with-the-authentication-api).
