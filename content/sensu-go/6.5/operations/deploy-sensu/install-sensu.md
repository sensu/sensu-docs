...
Invoke-WebRequest https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/6.5.3/sensu-go_6.5.3_windows_amd64.zip  -OutFile C:\Users\Administrator\sensu-go_6.5.3_windows_amd64.zip

# Or for Windows 386
Invoke-WebRequest https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/6.5.3/sensu-go_6.5.3_windows_386.zip  -OutFile C:\Users\Administrator\sensu-go_6.5.3_windows_386.zip

# Unzip the file with PowerShell for Windows amd64
Expand-Archive -LiteralPath 'C:\Users\Administrator\sensu-go_6.5.3_windows_amd64.zip' -DestinationPath 'C:\\Program Files\sensu\sensuctl\bin'

# or for Windows 386
Expand-Archive -LiteralPath 'C:\Users\Administrator\sensu-go_6.5.3_windows_386.zip' -DestinationPath 'C:\\Program Files\sensu\sensuctl\bin'
{{< /code >}}
...
Invoke-WebRequest https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/6.5.3/sensu-go-agent_6.5.3.5384_en-US.x64.msi  -OutFile "$env:userprofile\sensu-go-agent_6.5.3.5384_en-US.x64.msi"

# Or for Windows 386
Invoke-WebRequest https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/6.5.3/sensu-go-agent_6.5.3.5384_en-US.x86.msi  -OutFile "$env:userprofile\sensu-go-agent_6.5.3.5384_en-US.x86.msi"

# Install the Sensu agent for Windows amd64
msiexec.exe /i $env:userprofile\sensu-go-agent_6.5.3.5384_en-US.x64.msi /qn

# Or for Windows 386
msiexec.exe /i $env:userprofile\sensu-go-agent_6.5.3.5384_en-US.x86.msi /qn
