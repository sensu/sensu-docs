...
Click the options icon (three vertical dots) and select **Import**.

    {{< figure src="/images/personal_folder_import.png" alt="Import Sensu data in the Personal tab" link="/images/personal_folder_import.png" target="_blank" >}}
