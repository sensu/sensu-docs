...
type: "reference"
description: "Read this reference to learn to use tokens to fine-tune check attributes like alert thresholds on a per-entity level and reuse check definitions."
weight: 100
version: "6.5"
product: "Sensu Go"
menu:
