...
Sensu Go instances built from source do not include some free and commercial features such as the web UI homepage; see the [feature comparison matrix][15] to learn more.
