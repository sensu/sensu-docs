...
- [Configuration](#configuration)
  ...
  - [Example](/sensu-go/5.7/files/agent.yml)
...
sensu-agent --statsd-event-handlers influx-db --statsd-flush-interval 1 --statsd-metrics-host 123.4.5.7 --statsd-metrics-port 8125
{{< /highlight >}}
