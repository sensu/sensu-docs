...
**IMPROVEMENTS**
- ([Commercial feature][259]) In the web UI, added [X-Frame-Options][263] header to tell browsers the web application cannot be loaded within an iframe; loaded in this manner, it can be susceptible to tailored click jacking attacks. 
