...
Invoke-WebRequest https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/6.6.4/sensu-go-agent_6.6.4.5643_en-US.x64.msi  -OutFile "$env:userprofile\sensu-go-agent_6.6.4.5643_en-US.x64.msi"

# Or for Windows 386
Invoke-WebRequest https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/6.6.4/sensu-go-agent_6.6.4.5643_en-US.x86.msi  -OutFile "$env:userprofile\sensu-go-agent_6.6.4.5643_en-US.x86.msi"

# Install the Sensu agent for Windows amd64
msiexec.exe /i $env:userprofile\sensu-go-agent_6.6.4.5643_en-US.x64.msi /qn

# Or for Windows 386
msiexec.exe /i $env:userprofile\sensu-go-agent_6.6.4.5643_en-US.x86.msi /qn
