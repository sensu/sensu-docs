...
description: "Sensu core/v2/checks API endpoints provide HTTP access to check data. This reference includes examples for returning checks, creating checks, and more."
