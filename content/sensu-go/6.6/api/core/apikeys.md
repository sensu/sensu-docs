...
description: "Sensu core/v2/apikeys API endpoints provide HTTP access to API key data. This reference includes examples for returning API keys, creating API keys, and more."
