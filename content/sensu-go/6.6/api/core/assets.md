...
description: "Sensu core/v2/assets API endpoints provide HTTP access to asset data. This reference includes examples for returning assets, creating assets, and more."
