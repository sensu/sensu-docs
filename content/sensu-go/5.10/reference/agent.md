...
- [Configuration](#configuration)
  ...
  - [Example](/sensu-go/5.10/files/agent.yml)
...
sensu-agent --statsd-event-handlers influx-db --statsd-flush-interval 1 --statsd-metrics-host 123.4.5.10 --statsd-metrics-port 8125
{{< /highlight >}}
...
See the example config file provided with Sensu packages at `/usr/share/doc/sensu-go-agent-5.10.0/agent.yml.example` or [available here](/sensu-go/5.10/files/agent.yml).
...
See the example config file provided with Sensu packages at `%ALLUSERSPROFILE%\sensu\config\agent.yml.example` (default: `C:\ProgramData\sensu\config\agent.yml.example`) or [available here](/sensu-go/5.10/files/windows/agent.yml).
