...
{{< highlight shell >}}
sudo cp /usr/share/doc/sensu-go-backend-5.10.1/backend.yml.example /etc/sensu/backend.yml
{{< /highlight >}}
...
Download the Sensu agent for Windows [`amd64`](https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.10.1/sensu-go-agent_5.10.1.4462_en-US.x64.msi) or [`386`](https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.10.1/sensu-go-agent_5.10.1_2380_en-US.x86.msi) architectures.

{{< highlight text >}}
Invoke-WebRequest https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.10.1/sensu-go-agent_5.10.1.4462_en-US.x64.msi  -OutFile "$env:userprofile\sensu-go-agent_5.10.1.4462_en-US.x64.msi"
{{< /highlight >}}

Start the installation wizard.

{{< highlight text >}}
msiexec.exe /i $env:userprofile\sensu-go-agent_5.10.1.4462_en-US.x64.msi
{{< /highlight >}}
...
{{< highlight shell >}}
sudo cp /usr/share/doc/sensu-go-agent-5.10.1/agent.yml.example /etc/sensu/agent.yml
{{< /highlight >}}
...
Download [sensuctl for Windows `amd64`](https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.10.1/sensu-enterprise-go_5.10.1_windows_amd64.tar.gz).

{{< highlight text >}}
Invoke-WebRequest https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.10.1/sensu-enterprise-go_5.10.1_windows_amd64.tar.gz  -OutFile C:\Users\Administrator\sensu-enterprise-go_5.10.1_windows_amd64.tar.gz
{{< /highlight >}}

Or download [sensuctl for Windows `386`](https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.10.1/sensu-enterprise-go_5.10.1_windows_386.tar.gz).

{{< highlight text >}}
Invoke-WebRequest https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.10.1/sensu-enterprise-go_5.10.1_windows_386.tar.gz  -OutFile C:\Users\Administrator\sensu-enterprise-go_5.10.1_windows_386.tar.gz
{{< /highlight >}}
