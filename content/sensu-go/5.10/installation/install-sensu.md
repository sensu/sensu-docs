...
{{< highlight shell >}}
sudo cp /usr/share/doc/sensu-go-backend-5.10.0/backend.yml.example /etc/sensu/backend.yml
{{< /highlight >}}
...
{{< highlight shell >}}
sudo cp /usr/share/doc/sensu-go-agent-5.10.0/agent.yml.example /etc/sensu/agent.yml
{{< /highlight >}}
...
Download [sensuctl for Windows `amd64`](https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.10.0/sensu-enterprise-go_5.10.0_windows_amd64.tar.gz).

{{< highlight text >}}
Invoke-WebRequest https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.10.0/sensu-enterprise-go_5.10.0_windows_amd64.tar.gz  -OutFile C:\Users\Administrator\sensu-enterprise-go_5.10.0_windows_amd64.tar.gz
{{< /highlight >}}

Or download [sensuctl for Windows `386`](https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.10.0/sensu-enterprise-go_5.10.0_windows_386.tar.gz).

{{< highlight text >}}
Invoke-WebRequest https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.10.0/sensu-enterprise-go_5.10.0_windows_386.tar.gz  -OutFile C:\Users\Administrator\sensu-enterprise-go_5.10.0_windows_386.tar.gz
{{< /highlight >}}
