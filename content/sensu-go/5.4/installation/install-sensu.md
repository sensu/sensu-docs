...
{{< highlight shell >}}
sudo cp /usr/share/doc/sensu-go-backend-5.4.0/backend.yml.example /etc/sensu/backend.yml
{{< /highlight >}}
...
Download the [Sensu agent for Windows `amd64`](https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.4.0/sensu-enterprise-go_5.4.0_windows_amd64.tar.gz).

{{< highlight text >}}
Invoke-WebRequest https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.4.0/sensu-enterprise-go_5.4.0_windows_amd64.tar.gz  -OutFile "$env:userprofile\sensu-enterprise-go_5.4.0_windows_amd64.tar.gz"
{{< /highlight >}}

Or download the [Sensu agent for Windows `386`](https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.4.0/sensu-enterprise-go_5.4.0_windows_386.tar.gz).

{{< highlight text >}}
Invoke-WebRequest https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.4.0/sensu-enterprise-go_5.4.0_windows_386.tar.gz  -OutFile "$env:userprofile\sensu-enterprise-go_5.4.0_windows_amd64.tar.gz"
{{< /highlight >}}
...
{{< highlight shell >}}
sudo cp /usr/share/doc/sensu-go-agent-5.4.0/agent.yml.example /etc/sensu/agent.yml
{{< /highlight >}}
...
Download [sensuctl for Windows `amd64`](https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.4.0/sensu-enterprise-go_5.4.0_windows_amd64.tar.gz).

{{< highlight text >}}
Invoke-WebRequest https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.4.0/sensu-enterprise-go_5.4.0_windows_amd64.tar.gz  -OutFile C:\Users\Administrator\sensu-enterprise-go_5.4.0_windows_amd64.tar.gz
{{< /highlight >}}

Or download [sensuctl for Windows `386`](https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.4.0/sensu-enterprise-go_5.4.0_windows_386.tar.gz).

{{< highlight text >}}
Invoke-WebRequest https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.4.0/sensu-enterprise-go_5.4.0_windows_386.tar.gz  -OutFile C:\Users\Administrator\sensu-enterprise-go_5.4.0_windows_386.tar.gz
{{< /highlight >}}
...
{{< highlight shell >}}
curl -LO https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.4.0/sensu-enterprise-go_5.4.0_darwin_amd64.tar.gz
{{< /highlight >}}

Extract the archive.

{{< highlight shell >}}
tar -xvf sensu-enterprise-go_5.4.0_darwin_amd64.tar.gz
{{< /highlight >}}
...
[14]: https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.4.0/sensu-enterprise-go_5.4.0_linux_amd64.tar.gz
[15]: https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.4.0/sensu-enterprise-go_5.4.0_linux_arm64.tar.gz
[16]: https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.4.0/sensu-enterprise-go_5.4.0_linux_armv5.tar.gz
[17]: https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.4.0/sensu-enterprise-go_5.4.0_linux_armv6.tar.gz
[18]: https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.4.0/sensu-enterprise-go_5.4.0_linux_armv7.tar.gz
[19]: https://s3-us-west-2.amazonaws.com/sensu.io/sensu-go/5.4.0/sensu-enterprise-go_5.4.0_linux_386.tar.gz
