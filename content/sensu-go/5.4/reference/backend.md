...
- [Configuration](#configuration)
  ...
  - [Example](/sensu-go/5.4/files/backend.yml)
...
See the example config file provided with Sensu packages at `/usr/share/doc/sensu-go-backend-5.4.0/backend.yml.example` or [available here](/sensu-go/5.4/files/backend.yml).
