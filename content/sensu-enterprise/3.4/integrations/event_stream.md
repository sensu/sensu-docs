...
ring_buffer_size     | 
---------------------|------
description          | By default, the event stream integration uses a data stream buffer. The `ring_buffer_size` attribute sets the limit for writes to the buffer. To disable the buffer, set to `0`.
required             | false
type                 | Integer
default              | `1000`
