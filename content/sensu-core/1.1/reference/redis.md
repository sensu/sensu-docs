...
{{< highlight shell >}}
sudo wget -O /etc/redis/sentinel.conf http://docs.sensu.io/sensu-core/docs/1.0/files/sentinel.conf{{< /highlight >}}
...
sudo wget -O /etc/init.d/redis-sentinel http://docs.sensu.io/sensu-core/1.1/files/redis-sentinel{{< /highlight >}}
