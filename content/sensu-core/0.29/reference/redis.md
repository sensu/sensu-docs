...
{{< code shell >}}
sudo wget -O /etc/redis/sentinel.conf http://docs.sensu.io/sensu-core/0.29/files/sentinel.conf{{< /code >}}
...
sudo wget -O /etc/init.d/redis-sentinel http://docs.sensu.io/sensu-core/0.29/files/redis-sentinel{{< /code >}}
