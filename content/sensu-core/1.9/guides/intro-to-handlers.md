...
description: "Learn about Sensu handlers, which take action on events produced by checks. Handlers can send email alerts, create or resolve incidents, and store metrics."
product: "Sensu Core"
version: "1.9"
weight: 6
