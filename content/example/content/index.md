...
- Beautiful, readable and very user-friendly design based on Google's material
  ...
  and [easily customizable color palette]({{< relref "example/content/getting-started/index.md#changing-the-color-palette" >}}), great typography, as well as a
...
- Extra configuration options like a [project logo]({{< relref "example/content/getting-started/index.md#adding-a-logo" >}}), links to the authors
  [GitHub and Twitter accounts]({{< relref "example/content/getting-started/index.md#adding-a-github-and-twitter-account" >}}) and display of the amount of stars the
...
See the [getting started guide]({{< relref "example/content/getting-started/index.md" >}}) for instructions how to get
it up and running.
