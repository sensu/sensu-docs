...
1. To register a GitLab OAuth application, please navigate to your GitLab profile section and selection "Applications" => "New application".
  ...
  {{< figure src="/images/enterprise-dashboard-gitlab-app.png" alt="Register a new application in GitLab" link="/images/enterprise-dashboard-gitlab-app.png" target="_blank" >}}
...
4. Select "Submit" and note the application Application Id and Secret.
    ...
    {{< figure src="/images/subscriptions_line.png" alt="Application ID and Secret for registered GitLab application" link="/images/enterprise-dashboard-gitlab-secret.png" target="_blank" >}}
